...
import torch
from utils.evaluation_think import evaluation_test_think
...
def eval_t2m():
    ...
    for i in range(repeat_time):
        best_fid, best_div, best_top1, best_top2, best_top3, best_matching, best_multi = evaluation_test_think(args.out_dir, test_loader, model, eval_wrapper=eval_wrapper, draw=False, savenpy=False)
        fid.append(best_fid)
        div.append(best_div)
