...
@torch.no_grad()        
def evaluation_test_think_multimodality(out_dir, val_loader, model, eval_wrapper) : 
    ...
    for batch in tqdm(val_loader):
        ...
        for i in range(30):
            ...
            for k in range(bs):
                # pred_pose = model.net.forward_decoder(index_motion[k])
                try:
    ...
    msg = f"--> \t multimodality. {multimodality:.4f}"
    print(msg)
